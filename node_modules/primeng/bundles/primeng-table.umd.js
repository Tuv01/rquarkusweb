(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng/api'), require('primeng/paginator'), require('primeng/dom'), require('primeng/utils'), require('rxjs'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng/table', ['exports', '@angular/core', '@angular/common', 'primeng/api', 'primeng/paginator', 'primeng/dom', 'primeng/utils', 'rxjs', '@angular/cdk/scrolling'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.primeng = global.primeng || {}, global.primeng.table = {}), global.ng.core, global.ng.common, global.primeng.api, global.primeng.paginator, global.primeng.dom, global.primeng.utils, global.rxjs, global.ng.cdk.scrolling));
}(this, (function (exports, core, common, api, paginator, dom, utils, rxjs, scrolling) { 'use strict';
    ...
    ***************************************************************************** */
                    ...
                    for (var i = 0; i < this.value.length; i++) {
                        ...
                        if (this.filters['global'] && !globalMatch && globalFilterFieldsArray) {
                            for (var j = 0; j < globalFilterFieldsArray.length; j++) {
                                ...
                                globalMatch = utils.FilterUtils[this.filters['global'].matchMode](utils.ObjectUtils.resolveFieldData(this.value[i], globalFilterField), this.filters['global'].value, this.filterLocale);
                                if (globalMatch) {
                                    break;
                                }
                            }
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-body table') || dom.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-body table');
        ...
        Table.prototype.restoreColumnWidths = function () {
            if (this.columnWidthsState) {
                ...
                if (this.scrollable) {
                    ...
                    var bodyCols = dom.DomHandler.find(this.containerViewChild.nativeElement, '.p-datatable-scrollable-body table > colgroup > col');
    ...
    var SelectableRow = /** @class */ (function () {
        ...
        SelectableRow.prototype.findNextSelectableRow = function (row) {
            ...
            if (nextRow) {
                if (dom.DomHandler.hasClass(nextRow, 'p-datatable-selectable-row'))
                    return nextRow;
                else
        ...
        SelectableRow.prototype.findPrevSelectableRow = function (row) {
            ...
            if (prevRow) {
                if (dom.DomHandler.hasClass(prevRow, 'p-datatable-selectable-row'))
                    return prevRow;
                else
